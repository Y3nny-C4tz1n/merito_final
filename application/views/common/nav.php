        ...
        <div class="h-100" id="leftside-menu-container" data-simplebar="">
             ...
             <ul class="side-nav">
              ...
              <li class="side-nav-item">
               ...
               <?php if($idPerfil==1){?>
                ...
                class="side-nav-link <?=(in_array($menu,array("rdconjunto","rdeportista","rdparalimpico"))) ? "lol2": ""?>">
            ...
            <div class="collapse" id="sidebarConfig" >
                <ul class="side-nav">
                    ...
                    <li>
                        <a href="rdconjunto"
                        class="side-nav-link <?=(isset($menu) && $menu == "rdconjunto") ? "lol": ""?>">
                        <i class="bi bi-people"></i>
                        <span class="btn-label">D. Conjunto</span></a>
                    </li>
                    <li>
                        <a href="rdparalimpico"
                        class="side-nav-link <?=(isset($menu) && $menu == "rdparalimpico") ? "lol": ""?>">
                        <i class="bi bi-card-list"></i>
                        <span class="btn-label">D. Paralimpico</span></a>
                    </li>
                </ul>
            </div>
        </li>
